...
app.post("/api/register", (req, res) => {
  ...
  res
    .status(201)
    .json({ message: "Registration successful", userType, userId: id });
});
...
app.post("/api/faculty/:facultyId/grades", (req, res) => {
  console.log(
    `Faculty ${req.params.facultyId} received grade entry:`,
    req.body
  );
  res
    .status(200)
    .json({ message: "Grade received (not saved)", data: req.body });
});
